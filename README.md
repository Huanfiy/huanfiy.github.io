...
首页是一幅会随时间变化的手绘森林绘本：天空按本地时间在清晨、白昼、黄昏与夜晚之间切换，太阳沿弧线移动，夜里换成月牙、星星与草间萤火；远山、森林、山丘三层内联 SVG 随指针与滚动产生视差，落叶会被鼠标的风吹动。来自雾庭星屿的 OC「幻羽 / 小羽」缩小安放在首页森林右下角，不再占据正文分栏或显示常驻操作区：根据时段问候，点击切换姿态与离线短句，闲置时打盹；气泡仅在说话时出现，阅读后自动收起，临时气泡里的手记入口可查看设定、日常插画与相遇收藏。主题切换以按钮为圆心扩散揭示，卡片悬停带有跟随指针的柔光与纸片倾斜，首页页脚换成睡着的小羽，其他页面保留原有森林装饰。交互采用原生 HTML / CSS / JavaScript，角色插画为自托管 WebP，遵循 `prefers-reduced-motion`。
